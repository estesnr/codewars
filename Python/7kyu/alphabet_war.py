...
def alphabet_war(fight):
    # count the specified letters in the fight string and add them up with the appropriate values to get each side's score
    ...
    # compare each score and return the appropriate message in each case
